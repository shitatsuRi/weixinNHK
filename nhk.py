...
class NHK():
    ...
    def getArticleText(self, id, date=None):
        ...
        if os.path.exists(file_path):
            ...
            with open(file_path, "r", encoding="utf-8") as fp:
                return re.findall(r'<Content>(.*?)', fp.read())[0]
    ...
    def run(self, date=None):
        ...
        try:
            ...
            for news in info:
                id = news['news_id']
                ids_[id] = {'title': news['title_with_ruby']}
